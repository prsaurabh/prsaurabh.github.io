...
- **Commit after finishing each unit of work — do not wait for the user to ask.** User has explicitly opted in to auto-commits for this project. Batch only related changes; never leave finished work uncommitted between turns. If you also need to push, ask first unless the user already said push.
